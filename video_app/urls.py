...
from .views import upload_raw, upload_video, webcam_stream, webcam_stream_page, get_latest_video, detect_refresh, api_upload_video

urlpatterns = [
    path('upload/', api_upload_video, name='api_upload_video'),
    path('upload_raw/', upload_raw, name='upload_raw'),
